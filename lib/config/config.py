...
tf.app.flags.DEFINE_integer('step_size', 20000, "Step size for reducing the learning rate, currently only support one step")
...
def get_output_dir(imdb, weights_filename):
    ...
    (if not None).
    """
    outdir = osp.abspath(osp.join(FLAGS2["root_dir"], FLAGS2["root_dir"] , 'output/vgg16', imdb.name))
